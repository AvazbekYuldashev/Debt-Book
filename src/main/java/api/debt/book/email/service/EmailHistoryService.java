package api.debt.book.email.service;


import api.debt.book.app.enums.AppLanguage;
import api.debt.book.app.service.ResourceBoundleService;
import api.debt.book.email.entity.EmailHistoryEntity;
import api.debt.book.email.enums.EmailType;
import api.debt.book.email.repository.EmailHistoryRepository;
import api.debt.book.exception.exps.AttemptLimitException;
